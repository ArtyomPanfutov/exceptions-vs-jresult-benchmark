...
@Measurement(iterations = 1, time = 10, timeUnit = TimeUnit.NANOSECONDS)
@Warmup(iterations = 1, time = 10, timeUnit = TimeUnit.NANOSECONDS)
public class Benchmark {
    ...
    public static void main(String[] args) throws IOException {
        org.openjdk.jmh.Main.main(new String[]{ "-prof", "async:libPath=/Users/artyom/Downloads/async-profiler-3.0-macos/lib"});
    }
}
